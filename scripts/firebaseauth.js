...
import { getAuth,signInWithPhoneNumber, RecaptchaVerifier, onAuthStateChanged, signInWithPopup, GoogleAuthProvider, updateProfile, createUserWithEmailAndPassword, signInWithEmailAndPassword, sendPasswordResetEmail } from "https://www.gstatic.com/firebasejs/12.5.0/firebase-auth.js";
...
document.getElementById('a').addEventListener('click', e => {
    window.location.href = '/myrecipe/htmls/forgot.html'
})
...
form_sign.onsubmit = async (e) => {
    ...
    if (password.length > 5) {
        ...
        openDialogInfo('Password limit >=6')
    }
}
